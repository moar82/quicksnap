...
class RotatePane extends GLView {
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        switch(mOrientation) {
            ...
            case DOWN:
                ...
                setMeasuredSize(c.mRootView.getMeasuredWidth(c), c.getMeasuredHeight());
                break;
            case LEFT:
            case RIGHT:
                mChild.measure(heightSpec, widthSpec);
                setMeasuredSize(c.getMeasuredHeight(), c.mRootView.getMeasuredWidth(c));
        }
    }
    ...
    protected void render(GLRootView view, GL11 gl) {
        ...
        view.mEglConfigChooser.pushTransform(view);
        Matrix matrix = view.mContentView.getTransformation(view).getMatrix();
        float width = mRootView.getWidth(this);
        ...
        mChild.render(view, gl);
        view.mContentView.popTransform(view);
    }
